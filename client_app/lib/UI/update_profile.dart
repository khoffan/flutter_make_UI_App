...
class UpdateProfile extends StatefulWidget {
   UpdateProfile(
      {super.key, required this.stdid, required this.room, required this.dorm});
...
class _UpdateProfileState extends State<UpdateProfile> {
  ...
  void initState(){
    super.initState();
    stdController.text = widget.stdid;
    dormController.text = widget.dorm;
                          ...
                          children: [
                            _image != null
                                ...
                                : CircleAvatar(
                                    radius: 64,
                                    backgroundImage:
                                        AssetImage('assets/userpersonal.png')),
                            Positioned(
                              child: IconButton(
                                onPressed: () {
                                  selectImage();
